...
DoctorsCompanion doctorCompanion(Map<String, dynamic> r) =>
      DoctorsCompanion(
...
ChemistsCompanion chemistCompanion(Map<String, dynamic> r) =>
      ChemistsCompanion(
        id: Value(r['id'] as String),
...
ProductsCompanion productCompanion(Map<String, dynamic> r) {
    ...
    return ProductsCompanion(
      ...
      imageUrlsJson:
          Value(r['image_urls'] == null ? null : jsonEncode(r['image_urls'])),
      primaryImageUrl: Value(r['primary_image_url'] as String?),
      productMetadataJson:
          Value(meta == null ? null : jsonEncode(meta)),
